...
def main():
    ...
    num_species = 12 # The autoencoder is trained on the species and the temperature. 
    # The equivalence ratio and the initial temperature are not a pert of training the autoencoder
    ...
    for i in range(n_epochs+1):
        ...
        if i % savestep == 0:
            ...
            x_test = data.testbatch(ntest=500)
            y_pred = model(x_test)
    ...
    decoded_test = model.decode(encoded_test).numpy()
